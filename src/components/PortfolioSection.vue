...
<div class="container">
  ...
  <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
    ...
    <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
      ...
      <li data-filter=".filter-abundance">Magnet to Abundance</li>
      <li data-filter=".filter-habit">Reset Habits</li>
      <li data-filter=".filter-fitness">Fitness</li>
      <li data-filter=".filter-spiritual">Spiritual Guide</li>
    </ul><!-- End Portfolio Filters -->

    <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">

      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-abundance">
        <img src="/img/portfolio/app-1.jpg" class="img-fluid rounded" alt="">
      ...
      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-habit">
        <img src="/img/portfolio/product-1.jpg" class="img-fluid rounded" alt="">
        <div class="portfolio-info">
          <h4>Product 1</h4>
          <p>Lorem ipsum, dolor sit amet consectetur</p>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-fitness">
        <img src="/img/portfolio/branding-1.jpg" class="img-fluid rounded" alt="">
        <div class="portfolio-info">
          <h4>Branding 1</h4>
          <p>Lorem ipsum, dolor sit amet consectetur</p>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-spiritual">
        <img src="/img/portfolio/books-1.jpg" class="img-fluid rounded" alt="">
        <div class="portfolio-info">
          <h4>Books 1</h4>
          <p>Lorem ipsum, dolor sit amet consectetur</p>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-abundance">
        <img src="/img/portfolio/app-2.jpg" class="img-fluid rounded" alt="">
        <div class="portfolio-info">
          <h4>App 2</h4>
          <p>Lorem ipsum, dolor sit amet consectetur</p>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-habit">
        <img src="/img/portfolio/product-2.jpg" class="img-fluid rounded" alt="">
        <div class="portfolio-info">
          <h4>Product 2</h4>
          <p>Lorem ipsum, dolor sit amet consectetur</p>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-fitness">
        <img src="/img/portfolio/branding-2.jpg" class="img-fluid rounded" alt="">
        <div class="portfolio-info">
          <h4>Branding 2</h4>
          <p>Lorem ipsum, dolor sit amet consectetur</p>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-spiritual">
        <img src="/img/portfolio/books-2.jpg" class="img-fluid rounded" alt="">
        <div class="portfolio-info">
          <h4>Books 2</h4>
          <p>Lorem ipsum, dolor sit amet consectetur</p>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-abundance">
        <img src="/img/portfolio/app-3.jpg" class="img-fluid rounded" alt="">
        <div class="portfolio-info">
          <h4>App 3</h4>
          <p>Lorem ipsum, dolor sit amet consectetur</p>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-habit">
        <img src="/img/portfolio/product-3.jpg" class="img-fluid rounded" alt="">
        <div class="portfolio-info">
          <h4>Product 3</h4>
          <p>Lorem ipsum, dolor sit amet consectetur</p>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-fitness">
        <img src="/img/portfolio/branding-3.jpg" class="img-fluid rounded" alt="">
        <div class="portfolio-info">
          <h4>Branding 3</h4>
          <p>Lorem ipsum, dolor sit amet consectetur</p>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-spiritual">
        <img src="/img/portfolio/books-3.jpg" class="img-fluid rounded" alt="">
        <div class="portfolio-info">
          <h4>Books 3</h4>
          <p>Lorem ipsum, dolor sit amet consectetur</p>
